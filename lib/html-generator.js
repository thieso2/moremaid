...
<head>
    ...
    <style>
        ...
        .file-item:hover .content-snippet,
        .file-item:hover .content-snippet * {
        ...
        .file-item:hover .content-snippet .match-line {
        ...
        .file-item:hover .content-snippet .context-line {
                ...
                if (fileData) {
                    ...
                    if (fileData.matches && fileData.matches.length > 0) {
                        ...
                        snippetsToShow.forEach((match, matchIndex) => {
                            ...
                            snippet.style.cssText = 'margin-bottom: 12px !important; padding: 8px 12px !important; background: var(--code-bg) !important; border-left: 3px solid var(--link-color) !important; border-radius: 4px !important;';
