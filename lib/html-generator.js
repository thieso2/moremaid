    ...
    <div class="file-overlay" id="fileOverlay">
        <div class="file-overlay-content">
            <div class="file-overlay-header">
                ...
                <button class="file-overlay-copy" id="overlayCopy" title="Copy raw markdown">📋</button>
    ...
    <script>
        ...
        overlayCopy.addEventListener('click', async function() {
            ...
            try {
                ...
                const originalContent = overlayCopy.innerHTML;
                overlayCopy.innerHTML = '✓';
                overlayCopy.classList.add('copied');

                // Reset after 2 seconds
                setTimeout(() => {
                    overlayCopy.innerHTML = originalContent;
                    overlayCopy.classList.remove('copied');
                }, 2000);
            } catch (err) {
