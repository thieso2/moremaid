...
<body data-typography="default">
    ...
    <div class="help-modal" id="helpModal">
        <div class="help-modal-content">
            ...
            <h2>Moremaid - Help & Features</h2>

            <h3>🔍 Search</h3>
            <ul>
                <li><kbd>/</kbd> - Focus search field</li>
                <li><kbd>TAB</kbd> - Switch between filename and content search modes</li>
                <li><kbd>SHIFT+TAB</kbd> - Toggle search mode</li>
                <li><kbd>↑</kbd> <kbd>↓</kbd> - Navigate search results</li>
                <li><kbd>ENTER</kbd> - Open selected file</li>
                <li><kbd>ESC</kbd> - Clear search and unfocus</li>
            </ul>

            <h3>🖱️ File Navigation</h3>
            <ul>
                <li><strong>Click</strong> - Open file in overlay</li>
                <li><kbd>Ctrl/Cmd</kbd> + Click - Open file in new tab</li>
                <li><kbd>Shift</kbd> + Click - Open file in new tab</li>
                <li>Middle Click - Open file in new tab</li>
            </ul>

            <h3>⚙️ Controls (Bottom Left)</h3>
            <ul>
                <li><strong>Zoom</strong> - Adjust page zoom (50-200%)</li>
                <li><strong>Theme</strong> - Choose from 10 color themes</li>
                <li><strong>Typography</strong> - Select typography style</li>
            </ul>

            <h3>🎨 Available Themes</h3>
            <p>Light, Dark, GitHub, GitHub Dark, Dracula, Nord, Solarized Light/Dark, Monokai, One Dark</p>
            ...
            <h3>📋 Document View</h3>
            <ul>
                <li><kbd>ESC</kbd> - Close document overlay</li>
                <li>Click outside overlay - Close document</li>
                <li>URLs preserve document state - Reload keeps document open</li>
                <li>Browser back/forward buttons work with document navigation</li>
            </ul>

            <h3>🔗 Mermaid Diagrams</h3>
            <ul>
                <li>Click <strong>⛶</strong> button on diagram - Open in new window</li>
                <li>Diagrams render automatically in documents</li>
            </ul>

            <h3>⌨️ Global Shortcuts</h3>
            <ul>
                <li><kbd>Cmd/Ctrl</kbd> + <kbd>K</kbd> - Focus search</li>
                <li><kbd>?</kbd> (this button) - Show help</li>
            </ul>

            <h3>💡 Tips</h3>
            <ul>
                <li>Sort files by clicking column headers (Name, Size, Modified)</li>
                <li>Content search searches inside markdown files</li>
                <li>All settings (theme, zoom) are saved automatically</li>
                <li>When server disconnects, tab title shows [DISCONNECTED]</li>
            </ul>
        </div>
    </div>
