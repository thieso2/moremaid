                        ...
                        snippetsToShow.forEach(match => {
                            ...
                            if (match.contextLines && match.contextLines.length > 0) {
                                match.contextLines.forEach(line => {
                                    ...
                                    lineContent.innerHTML = 'Line ' + line.lineNumber + ': ' + (line.isMatch ? highlightMatch(line.text, query) : line.text);
                                ...
                                lineDiv.innerHTML = 'Line ' + match.lineNumber + ': ' + highlightMatch(lineText, query);
                                snippet.appendChild(lineDiv);
                            }
