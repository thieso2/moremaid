...
async function startFolderServer(folderPathOrFS, isTemp = false, selectedTheme = null) {
    ...
    const server = http.createServer(async (req, res) => {
        ...
        if (pathname === '/') {
            ...
            // Redirect to /index for regular mode
...
<body data-typography="default">
    <div class="container">
        ...
        <div class="path">${baseDir}</div>
            ...
            // Inject WebSocket client code (it will check if in iframe)
            if (isTemp) {
            ...
            try {
                ...
                let html = generateHtmlFromMarkdown(markdown, path.basename(file), false, true, selectedTheme);
